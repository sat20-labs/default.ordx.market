...
const footer_content = {
    ...
    social_links : [
      ...
      //   },
        ...
        {
          link: "https://t.me/+oV5tM9g3chphNDE1",
          target: "_blank",
...
const FooterTwo = () => {
    ...
    <div className="tp-footer__pl-pr grey-bg-2">
      <div className="tp-footer__area pt-0 tp-footer__tp-border-bottom">
         <div className="container">
            <div className="row">
               <div className="col-xl-3 col-lg-3 col-md-6 pb-1 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
      ...
      <div className="tp-copyright__area pt-10 pb-20">
         <div className="container">
